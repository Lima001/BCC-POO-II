...
if __name__ == "__main__":
    ...
    p1 = Plano(nomenclatura="Família I", duracao_maxima=21, duracao_minima=1, limite_kilometragem=10000, preco_diaria=100, qtd_max_parcelas=5)
    p2 = Plano(nomenclatura="Frota Empresarial", duracao_maxima=365, duracao_minima=180, limite_kilometragem=None, preco_diaria=0, qtd_max_parcelas=5)
    p3 = Plano(nomenclatura="Família II", duracao_maxima=21, duracao_minima=1, limite_kilometragem=15000, preco_diaria=200, qtd_max_parcelas=5)
    p4 = Plano(nomenclatura="Luxo", duracao_maxima=7, duracao_minima=1, limite_kilometragem=2000, preco_diaria=350, qtd_max_parcelas=2)
    p5 = Plano(nomenclatura="Trabalho I", duracao_maxima=30, duracao_minima=30, limite_kilometragem=20000, preco_diaria=75, qtd_max_parcelas=10)
    p6 = Plano(nomenclatura="Fideliade I", duracao_maxima=365, duracao_minima=365, limite_kilometragem=None, preco_diaria=30, qtd_max_parcelas=12)
    ...
    print((5*al1.veiculo_plano.plano.preco_diaria - (5*al1.veiculo_plano.plano.preco_diaria * (al1.cupom_desconto.desconto)/100))/2)
