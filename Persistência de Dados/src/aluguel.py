...
class Aluguel(db.Model):
    ...
    # Atributos comuns da classe aluguel que serão mapeados para colunas em uma Tabela
    ...
    def json(self):
        ...
        # Verificar se existe a relação de agregação
        if self.cupom_desconto:
            # Caso exista, iremos adicionar as informações do objeto relacionado ao retorno JSON
...
if __name__ == "__main__":
    ...
    # Exibição dos objetos instância de Aluguel criados e agora persistidos
    # Observe que trazemos as informações do outros objetos relacioandos a cada alguel
